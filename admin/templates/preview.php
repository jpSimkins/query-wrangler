...
<div id="query-details">
	<div class="group">
		<div class="qw-setting-header"><?php _e( 'Arguments' ); ?></div>
	...
	<div class="group">
		<div class="qw-setting-header"><?php _e( 'Display Settings' ); ?></div>
	...
	<div class="group">
		<div class="qw-setting-header"><?php _e( 'All Options' ); ?></div>
